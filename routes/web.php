...
Route::group(['middleware'=> 'auth'],function(){
    ...
    Route::get('/fourexport', [App\Http\Controllers\FournisseurController::class, 'fourexport'])->name('fourexport');
    Route::get('/panelexport', [App\Http\Controllers\PanelController::class, 'panelexport'])->name('panelexport');
    Route::get('/abmtexport', [App\Http\Controllers\PackController::class, 'abmtexport'])->name('abmtexport');
